...
adjectives_more_less <- str_extract_all(Macbeth_raw, "\\b\\w+(?:more|less)\\b", simplify = TRUE)
adjectives_more_less <- unique(adjectives_more_less)
print(adjectives_more_less)
...
```{r}
exit_lines <- grep("\\bExit\\b|\\bExeunt\\b", Macbeth_raw, value = TRUE)
print(exit_lines)
